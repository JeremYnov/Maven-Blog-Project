...
<body>
	...
	<h1 class="display-4 text-center"><u>Article(s) écris par ${ autor.getName() }</u></h1>
	
	<div class="container">
	<c:if test="${empty autorArticle}">
	<div class="alert alert-warning" role="alert">
  L'utilisateur n'a pas écris d'article pour le moment, nous vous invitons donc à revenir plus tard. 
</div>
	</c:if>
	<div class="row">
